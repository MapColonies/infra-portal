...
To add, update, or remove an endpoint to scrape, or to modify an entire scrape job, you need to create a pull request in the repository
[helm-charts](https://github.com/MapColonies/helm-charts). Make your changes in the `infra/values/scrape-values.yaml` file.
