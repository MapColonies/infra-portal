...
![Bundler build with parameters](./img/bundler-1.png)
* Click on `Choose File` and upload the `artifacts.json` from you local computer.  
![Bundler browse artifacts file](./img/bundler-2.png)
* Click the Build button
![Bundler build button](./img/bundler-3.png)
...
![Unbundler browse file](./img/bundler-slack.png)
* Click the `build` button
