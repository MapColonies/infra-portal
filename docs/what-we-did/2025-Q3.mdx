...
![Minio Dashboard](/img/what-we-did/2025-q3/minio-dashboard.png)
...
![Token Kiosk](/img/what-we-did/2025-q3/token-kiosk.png)
...
### 💾 Easy Access to Shared Data in Any Namespace
Ever needed to access our integration shared data from your own namespace?  
We've made it simple and created a new Jenkins pipeline called `duplicate-shared-pvc`.  
Just run the pipeline and provide your namespace name. 
It will automatically create a new PV and PVC right in your namespace, pointing to the central shared disk.  
This gives you easy access to all the data you need without any duplication of disks.

You can find the pipeline [here](https://jenkins.mapcolonies.net/job/duplicate-shared-pvc/build?delay=0sec).

:::info
After all the PVC migrations are done, the old disks will be deleted
:::
...
![Checkmate](/img/what-we-did/2025-q3/checkmate.png)
