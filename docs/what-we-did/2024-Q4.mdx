...
![tempo filtering by properties](/img/what-we-did/2024-q4/tempo-filtering.png)
...
![Kube State Metrics Usage Example](/img/what-we-did/2024-q4/ksm.png)
...
For more information, see [this page](/docs/guides/helm-diff.mdx).
...
![Slack Message](/img/what-we-did/2024-q4/blame.png)
